...
const PageNotreProjet = () => (
  <div className="main-content">
    ...
    <p>&lt;ici, centrée, la Video Happi&gt;</p>
    ...
    <p>Au Sénégal en 2016, on estime que plus de 4 personnes sur 10 n’ont pas accès à l’électricité. Le pays présente un taux d’électrification de 56,7% en 2017 [2]. Seules 20% des personnes résidant en zones rurales bénéficient de ces avancées technologiques.</p>
    ...
    <p>//ici image senegal.png et casamance.png. Sous le paragraphe mais les images sont cote à cote</p>
    <h4>La Casamance</h4>
    ...
    <p>Théâtre d’un long conflit armé endormi depuis le début des années 1980, la Casamance est aujourd’hui relativement pacifiée mais souffre d’une pauvreté structurelle. Plus de 75% de ses habitants de Casamance vivent encore en dessous du seuil de pauvreté [3].</p>
    ...
    <p>//ici image villages.png et villages2.png. la je pense que je vais faire une autre image, car c'est genre l'une sur l'autre</p>
    ...
    <p>//ici image kitSolaire.png. Sur la droite des 2 derniers paragraphes</p>
    ...
    <p>//ici image cagnotte.png a droite du paragraphe et repartitionBudget.png en dessous</p>
